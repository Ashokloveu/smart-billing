...
export const PaymentInModal: React.FC<PaymentInModalProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <div style={styles.header}>
          <h2 style={styles.title}>Add Payment In</h2>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          {/* Row 3: Received Amount & Payment Method */}
          <div style={styles.twoCol}>
            <div style={styles.formGroup}>
          ...
          <div style={styles.attachRow}>
            <button type="button" style={styles.cameraBtn} title="Attach Photo or Receipt">
              📷
            </button>
          </div>
